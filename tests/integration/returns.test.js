...
describe ('/api/returns', () => {
    ...
    it('should return 200 if return is a valid request', async () => {
        const res = await exec();
        
        expect(res.status).toBe(200);
    });

    it('should return rental object with the correct returndate if valid request', async () => {
        const res = await exec();
    ...
    it('should Rental Fee if input is valid', async () => {
